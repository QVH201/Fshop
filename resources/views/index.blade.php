                  ...
                  <div class="swiper-slide product-card product-card_style3">
                    <div class="pc__img-wrapper">
                      <a href="{{ route('shop.product.details', ['product_slug' => $product->slug]) }}">
                        ...
                        @php
                            $galleryImages = explode(",", $product->image);
                            $secondImage = count($galleryImages) > 1 ? $galleryImages[1] : $product->image;
                        @endphp
                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $secondImage }}" width="258" height="313"
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div
                        ...
                        <button class="pc__btn-wl bg-transparent border-0 js-add-wishlist filled-heart" title="Added To Wishlist">
